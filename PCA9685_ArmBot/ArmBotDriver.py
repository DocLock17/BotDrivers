...
if __name__ == '__main__':
    ...
    try:
        ...
        AB.base_posture(5)
        print("1")
        AB.flex_servo(30, 1, servo_number=8, servo_name="")
        print("2")
        AB.flex_servo(40, 1, servo_number=5)
        print("3")
        AB.flex_servo(50, 1, 8)
        print("4")
        AB.flex_servo(60, 1, servo_number=86, servo_name="distal_flexor")
        print("5")
        AB.flex_servo(70, 1, servo_name="distal_rotater")
        print("6")
        AB.flex_servo(80, 1, 86, servo_name="medial_rotater")
        print("7")
        AB.flex_servo(90, 1, servo_name="distal_rotater")
        print("8")
